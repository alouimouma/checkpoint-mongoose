...
const dbURI =
    "mongodb+srv://mohamed:mouma12est14est14@mongoose.cr5ja.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
app.get("/add_many", (req, res) => {
    Person.create([
        ...
        { name: "ahmed", age: 28, favoriteFoods: ["pizza", "salad"] },
        { name: "mostfa", age: 18, favoriteFoods: ["chicken wings"] },
        {
            name: "samar",
            age: 35,
...
//findById
let id = "60ce7c4049b3e2b6da91d65f";
...
const personId = "60ce7c4049b3e2b6da91d65f";
...
app.get("/LikeBurrito", (req, res) => {
    Person.find({ favoriteFoods: { $in: "burrito" } })
        ...
        .exec((err, data) => {
            err
                ? console.log(
                      "error while looking for people who like burrito",
                      err
                  )
